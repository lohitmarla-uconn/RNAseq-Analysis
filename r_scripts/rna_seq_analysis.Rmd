...
# 📌 GO Enrichment Analysis for Mouse
...
```
```{r,  warning=FALSE, message=FALSE}
# 📌 KEGG Pathway Enrichment Analysis (Mouse)
...
```
```{r,  warning=FALSE, message=FALSE}
# 📌 Reactome Pathway Enrichment Analysis (Mouse)
...
# 📌 Plot GO Enrichment with Smaller Font
...
```
```{r,  warning=FALSE, message=FALSE}
# 📌 Plot KEGG Pathway Enrichment with Smaller Font
...
```
```{r,  warning=FALSE, message=FALSE}
# 📌 Plot Reactome Pathway Enrichment with Smaller Font
...
```
```{r,  warning=FALSE, message=FALSE}
# 📌 Extract top 10 significant GO terms based on adjusted p-value
top_go_terms <- go_results@result[order(go_results@result$p.adjust), ][1:10, ]

# 📌 Visualize GO Enrichment Bar Plot
...
# ✅ End of Analysis
print("🚀 Mouse RNA-Seq Analysis Complete!")
